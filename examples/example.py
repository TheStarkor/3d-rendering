...
# Fuze trimesh
fuze_trimesh = trimesh.load('./models/cube.STL')
fuze_mesh = Mesh.from_trimesh(fuze_trimesh)

# Drill trimesh
drill_trimesh = trimesh.load('./models/cube.STL')
...
# Wood trimesh
wood_trimesh = trimesh.load('./models/cube.STL')
wood_mesh = Mesh.from_trimesh(wood_trimesh)

# Water bottle trimesh
bottle_gltf = trimesh.load('./models/cube.STL')
